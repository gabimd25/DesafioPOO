...
public class Veiculo {
    ...
    public void abastecer(int combustivel){
        if(litrosCombustivel+combustivel<=60)
            ...
            System.out.printf("O carro já possui %d, o abastecimento máximo é de %d litros", litrosCombustivel,capacidadeTanque-litrosCombustivel);
        }
    }
    ...
    public void pintar(String cor){
        setCor(cor);
        System.out.printf("A nova cor do carro é %s", this.cor);
    }
    ...
    public void desligar(){
        if(velocidade==0)
        {
            ...
            System.out.println("O carro só pode ser desligado quando está parado.");
        }
    }
}
